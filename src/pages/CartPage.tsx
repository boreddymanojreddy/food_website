...
import { ChevronLeft, ChevronRight, Plus, Minus, Trash2, ShoppingBag } from 'lucide-react';
import { useCart } from '../contexts/CartContext';
import { useAuth } from '../contexts/AuthContext';

const CartPage: React.FC = () => {
  const { cartItems, updateQuantity, removeFromCart, updateSpecialInstructions, cartTotal } = useCart();
              ...
              <div className="card p-6 sticky top-24">
                ...
                <div className="flex justify-between mb-6">
                  ...
                  <span className="font-bold text-lg">
                    ₹{(cartTotal + 0.00 + (cartTotal * 0.08)).toFixed(2)}
                  </span>
                </div>
